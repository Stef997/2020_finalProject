...
set CLASSPATH=%APP_HOME%\lib\sample.jar;%APP_HOME%\lib\javafx.fxml.jar;%APP_HOME%\lib\javafx-swt.jar;%APP_HOME%\lib\javafx.media.jar;%APP_HOME%\lib\javafx.graphics.jar;%APP_HOME%\lib\javafx.swing.jar;%APP_HOME%\lib\javafx.web.jar;%APP_HOME%\lib\javafx.controls.jar;%APP_HOME%\lib\javafx.base.jar;%APP_HOME%\lib\annotations-16.0.2.jar;%APP_HOME%\lib\guava-28.1-jre.jar;%APP_HOME%\lib\javafx-fxml-11.0.2-mac.jar;%APP_HOME%\lib\javafx-controls-11.0.2-mac.jar;%APP_HOME%\lib\javafx-controls-11.0.2.jar;%APP_HOME%\lib\javafx-graphics-11.0.2-mac.jar;%APP_HOME%\lib\javafx-graphics-11.0.2.jar;%APP_HOME%\lib\javafx-base-11.0.2-mac.jar;%APP_HOME%\lib\javafx-base-11.0.2.jar;%APP_HOME%\lib\failureaccess-1.0.1.jar;%APP_HOME%\lib\listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\checker-qual-2.8.1.jar;%APP_HOME%\lib\error_prone_annotations-2.3.2.jar;%APP_HOME%\lib\j2objc-annotations-1.3.jar;%APP_HOME%\lib\animal-sniffer-annotations-1.18.jar

@rem Execute sample
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" sample.Main %CMD_LINE_ARGS%
